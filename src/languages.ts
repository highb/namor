...
export const LANG_DATA: Record<string, string[]> = {
  ...
  vi: namesVi,
  zh: namesZh,
  "myth-african": mythAfrican,
  "myth-aboriginal": mythAboriginal,
  "myth-aztec": mythAztec,
  "myth-baltic": mythBaltic,
  "myth-buddhist": mythBuddhist,
  "myth-celtic": mythCeltic,
  "myth-egyptian": mythEgyptian,
  "myth-etruscan": mythEtruscan,
  "myth-finnish": mythFinnish,
  "myth-greek": mythGreek,
  "myth-hindu": mythHindu,
  "myth-japanese": mythJapanese,
  "myth-lithuanian": mythLithuanian,
  "myth-maya": mythMaya,
  "myth-melanesian": mythMelanesian,
  "myth-mesoamerican": mythMesoamerican,
  "myth-mesopotamian": mythMesopotamian,
  "myth-mideast": mythMideast,
  "myth-nativeamerican": mythNativeamerican,
  "myth-norse": mythNorse,
  "myth-oceanic": mythOceanic,
  "myth-polynesian": mythPolynesian,
  "myth-roman": mythRoman,
  "myth-slavic": mythSlavic,
  "myth-southamerican": mythSouthamerican,
  "myth-yoruba": mythYoruba,
};
